...
- 🏡 **[Bengoloro House Prediction Project](https://github.com/abbaskhan0345/Bengoloro_House_prediction_project)** – An end-to-end machine learning solution for predicting house prices in Bengaluru, India, using features like location, size, and bathrooms. Deployed as a Gradio web app on Hugging Face.
- 📊 **[Data Science Specialization Coursera](https://github.com/abbaskhan0345/Data-Science-Specialization-Coursera-)** – Repository for Data Science Specialization on Coursera, featuring Jupyter Notebooks.
- 🏗️ **[Software Design and Architecture](https://github.com/abbaskhan0345/Software-Design-and-Architecture-)** – University course repository focused on software design principles in Python.
- 🔢 **[NumPy Learning](https://github.com/abbaskhan0345/numpy-learning)** – Collection of examples and mini-projects showcasing NumPy essentials for scientific computing and data analysis.
- 🐍 **[Python Basics](https://github.com/abbaskhan0345/python-basics)** – Beginner-friendly repository with notebooks, examples, and exercises for learning Python fundamentals.
- 📈 **[Data Visualization Python](https://github.com/abbaskhan0345/data-visualization-python)** – Projects and examples for data visualization using Python libraries like Matplotlib and Seaborn.
---
## 📚 Publications
- **[PROVIDING DATA INTEGRITY SERVICE IN CLOUD](https://sesjournal.org/index.php/1/article/view/1162)** | Spectrum of Engineering Sciences
- **[ADAPTIVE FUZZY LOGIC TRAFFIC CONTROL SYSTEM FOR OPTIMIZED FLOW AND EMERGENCY VEHICLE PRIORITY](https://sesjournal.org/index.php/1/article/view/1348)** | Spectrum of Engineering Sciences
---
## 📊 GitHub Stats
<p align="center">
